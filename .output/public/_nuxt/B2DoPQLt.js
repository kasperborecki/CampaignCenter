import{W as t,ak as m,bz as l,aC as c,B as s,C as p,ae as i,D as g,af as d}from"./CCV3VslT.js";var h=`
    .p-imagecompare {
        position: relative;
        overflow: hidden;
        width: 100%;
...
`,u={root:"p-imagecompare",slider:"p-imagecompare-slider"},b=t.extend({name:"imagecompare",style:h,classes:u}),f={name:"BaseImageCompare",extends:m,props:{tabindex:{type:Number,default:0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:b,provide:function(){return{$pcImageCompare:this,$parentInstance:this}}},v={name:"ImageCompare",extends:f,methods:{onSlide:function(a){var n=a.target.value,o=a.target.previousElementSibling;l(o,c("imagecompare.scope.x").name,"".concat(n,"%"))}}},w=["aria-labelledby","aria-label"];function z(e,a,n,o,k,r){return s(),p("div",d({class:e.cx("root"),"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptmi("root")),[i(e.$slots,"left"),i(e.$slots,"right"),g("input",d({type:"range",min:"0",max:"100",value:"50",onInput:a[0]||(a[0]=function(){return r.onSlide&&r.onSlide.apply(r,arguments)}),class:e.cx("slider")},e.ptm("slider")),null,16)],16,w)}v.render=z;export{v as default};
