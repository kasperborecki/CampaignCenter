import{W as c,ak as d,aD as m,B as i,C as a,ae as t,O as g,af as o,ag as p,U as u}from"./CCV3VslT.js";import{s as f,a as b}from"./C0fr9gJr.js";import{s as h}from"./DKvUkhfd.js";var y=`
    .p-inlinemessage {
        display: inline-flex;
        align-items: center;
...
`,w={root:function(e){var s=e.props,r=e.instance;return["p-inlinemessage p-component p-inlinemessage-"+s.severity,{"p-inlinemessage-icon-only":!r.$slots.default}]},icon:function(e){var s=e.props;return["p-inlinemessage-icon",s.icon]},text:"p-inlinemessage-text"},v=c.extend({name:"inlinemessage",style:y,classes:w}),k={name:"BaseInlineMessage",extends:d,props:{severity:{type:String,default:"error"},icon:{type:String,default:void 0}},style:v,provide:function(){return{$pcInlineMessage:this,$parentInstance:this}}},x={name:"InlineMessage",extends:k,inheritAttrs:!1,timeout:null,data:function(){return{visible:!0}},mounted:function(){var e=this;this.sticky||setTimeout(function(){e.visible=!1},this.life)},computed:{iconComponent:function(){return{info:b,success:m,warn:f,error:h}[this.severity]}}};function $(n,e,s,r,B,l){return i(),a("div",o({role:"alert","aria-live":"assertive","aria-atomic":"true",class:n.cx("root")},n.ptmi("root")),[t(n.$slots,"icon",{},function(){return[(i(),g(p(n.icon?"span":l.iconComponent),o({class:n.cx("icon")},n.ptm("icon")),null,16,["class"]))]}),n.$slots.default?(i(),a("div",o({key:0,class:n.cx("text")},n.ptm("text")),[t(n.$slots,"default")],16)):u("",!0)],16)}x.render=$;export{x as default};
