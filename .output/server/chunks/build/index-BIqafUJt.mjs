globalThis.__timing__.logStart('Load chunks/build/index-BIqafUJt');import { isTouchDevice } from '@primeuix/utils/dom';
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return renderSlot(_ctx.$slots, "default", {
      ...
      return [createVNode(_component_OtpInputText, {
        ...
        name: _ctx.$formName ? _ctx.$formName + "_" + (i - 1) : void 0,
...
export { script as default };;globalThis.__timing__.logEnd('Load chunks/build/index-BIqafUJt');
//# sourceMappingURL=index-BIqafUJt.mjs.map
