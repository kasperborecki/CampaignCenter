globalThis.__timing__.logStart('Load chunks/build/index-BsXPcOl7');import { cn } from '@primeuix/utils';
...
var script = {
      ...
      if (this.panels && this.panels.length) {
        ...
        if (!initialized) {
          ...
          this.panels.map(function(panel, i) {
            var panelSize = _this.getPanelSize(panel);
  ...
  computed: {
    ...
    panelSizeConfig: function panelSizeConfig2() {
      var _this7 = this;
      return this.panels.map(function(panel) {
        return _this7.getPanelSize(panel);
      }).join(",");
    },
...
export { script as default };;globalThis.__timing__.logEnd('Load chunks/build/index-BsXPcOl7');
//# sourceMappingURL=index-BsXPcOl7.mjs.map
