globalThis.__timing__.logStart('Load chunks/build/index-C0I7RpQC');import { hasClass, findSingle, getOuterWidth, getOuterHeight, getViewport, removeClass, addClass, getWindowScrollLeft, getWindowScrollTop, createElement, isExist, fadeIn, isTouchDevice, getAttribute } from '@primeuix/utils/dom';
import { isEmpty } from '@primeuix/utils/object';
import { uuid } from '@primeuix/utils/uuid';
import { ZIndex } from '@primeuix/utils/zindex';
import { C as ConnectedOverlayScrollHandler } from './index-1v7fOn3J.mjs';
import { B as BaseDirective } from './index-Dl3T3yr5.mjs';
...
var Tooltip = BaseTooltip.extend("tooltip", {
  ...
  methods: {
    ...
    show: function show(el, options, showDelay) {
      ...
      if (showDelay !== void 0) {
        el.$_ptooltipShowTimer = setTimeout(function() {
    ...
    hide: function hide(el, hideDelay) {
      ...
      el.$_ptooltipPendingShow = false;
      if (hideDelay !== void 0) {
        el.$_ptooltipHideTimer = setTimeout(function() {
...
export { Tooltip as T };;globalThis.__timing__.logEnd('Load chunks/build/index-C0I7RpQC');
//# sourceMappingURL=index-C0I7RpQC.mjs.map
