globalThis.__timing__.logStart('Load chunks/build/index-CKhvF97m');import { cn } from '@primeuix/utils';
...
import { s as script$2 } from './index-CP_fvbAb.mjs';
import { s as script$4 } from './index-CobSNMix.mjs';
import { s as script$5 } from './index-CLrwot36.mjs';
import { s as script$3 } from './index-RZE_erJD.mjs';
import { s as script$6 } from './index-BJFn3Jal.mjs';
import script$c from './index-DUorkBwK.mjs';
import script$9 from './index-Yah_V72u.mjs';
import script$8 from './index-DDTkROm7.mjs';
import script$7 from './index-CGTrSIDr.mjs';
import script$d from './index-wEFFy2XM.mjs';
import { O as OverlayEventBus } from './index-rAVNvoJo.mjs';
import { s as script$a } from './index-zZrFrjQS.mjs';
import { R as Ripple } from './index-DmGtcQDa.mjs';
import script$b from './index-CXHjtVgb.mjs';
import { s as script$e } from './index-xRlVhXwl.mjs';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return [_ctx.display === "comma" ? (openBlock(), createElementBlock(Fragment, {
      ...
      key: 1
    }, [_ctx.loading && (!_ctx.options || _ctx.options.length === 0) ? (openBlock(), createElementBlock(Fragment, {
      key: 0
    }, [createTextVNode(toDisplayString(_ctx.placeholder || "empty"), 1)], 64)) : $options.chipSelectedItems ? (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString($options.label), 1)) : (openBlock(true), createElementBlock(Fragment, {
      key: 2
    }, renderList(_ctx.d_value, function(item, idx) {
      return openBlock(), createElementBlock("span", mergeProps({
        key: "chip-".concat($options.getLabelByValue(item), "_").concat(idx),
...
export { script as default };;globalThis.__timing__.logEnd('Load chunks/build/index-CKhvF97m');
//# sourceMappingURL=index-CKhvF97m.mjs.map
