globalThis.__timing__.logStart('Load chunks/build/index-DKGroQ-w');import { cn } from '@primeuix/utils';
...
import { s as script$2 } from './index-BH9iduCK.mjs';
import { s as script$3 } from './index-CP_fvbAb.mjs';
import { s as script$6 } from './index-CobSNMix.mjs';
import { s as script$4 } from './index-CLrwot36.mjs';
import { s as script$5 } from './index-RZE_erJD.mjs';
import { s as script$7 } from './index-BJFn3Jal.mjs';
import script$8 from './index-DDTkROm7.mjs';
import script$9 from './index-CGTrSIDr.mjs';
import script$c from './index-wEFFy2XM.mjs';
...
import { s as script$d } from './index-xRlVhXwl.mjs';
...
var script = {
  ...
  methods: {
    ...
    onOverlayEnter: function onOverlayEnter(el) {
      ...
      setTimeout(function() {
        _this5.autoFilterFocus && _this5.filter && focus(_this5.$refs.filterInput.$el);
    ...
    onOverlayLeave: function onOverlayLeave(el) {
      ...
      if (this.autoFilterFocus && this.filter && !this.editable) {
        this.$nextTick(function() {
          if (_this6.$refs.filterInput) {
            focus(_this6.$refs.filterInput.$el);
          }
        });
      }
      this.$emit("hide");
    ...
    bindOutsideClickListener: function bindOutsideClickListener() {
      ...
      if (!this.outsideClickListener) {
        this.outsideClickListener = function(event) {
          ...
          if (_this7.overlayVisible && _this7.overlay && !composedPath.includes(_this7.$el) && !composedPath.includes(_this7.overlay)) {
            _this7.hide();
          }
        };
    ...
    bindResizeListener: function bindResizeListener() {
      ...
      if (!this.resizeListener) {
        this.resizeListener = function() {
          if (_this9.overlayVisible && !isTouchDevice()) {
            _this9.hide();
          }
        };
...
export { script as default };;globalThis.__timing__.logEnd('Load chunks/build/index-DKGroQ-w');
//# sourceMappingURL=index-DKGroQ-w.mjs.map
