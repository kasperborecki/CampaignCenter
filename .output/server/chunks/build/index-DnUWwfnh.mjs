globalThis.__timing__.logStart('Load chunks/build/index-DnUWwfnh');import { $dt } from '@primeuix/styled';
...
import { s as script$2 } from './index-zZrFrjQS.mjs';
...
var script = {
  ...
  methods: {
    ...
    bindContentResizeListener: function bindContentResizeListener() {
      var _this5 = this;
      if (!this.contentResizeObserver) {
        this.contentResizeObserver = new ResizeObserver(function() {
          if (_this5.visible) {
            _this5.alignOverlay();
          }
        });
    ...
    unbindContentResizeListener: function unbindContentResizeListener() {
      if (this.contentResizeObserver) {
...
export { script as default };;globalThis.__timing__.logEnd('Load chunks/build/index-DnUWwfnh');
//# sourceMappingURL=index-DnUWwfnh.mjs.map
