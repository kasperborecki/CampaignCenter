globalThis.__timing__.logStart('Load chunks/build/index-DwvJJeMK');import { $dt } from '@primeuix/styled';
import { find, findSingle, focus } from '@primeuix/utils/dom';
import { s as script$2 } from './index-CPX8QLh4.mjs';
import script$3 from './index-xKFz547g.mjs';
import { R as Ripple } from './index-DmGtcQDa.mjs';
import { T as Tooltip } from './index-C0I7RpQC.mjs';
import { s as script$4 } from './index-DI7ROuCk.mjs';
import { style } from '@primeuix/styles/speeddial';
import { B as BaseStyle } from './server.mjs';
import { resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment, createElementVNode, mergeProps, renderSlot, createVNode, withCtx, createBlock, resolveDynamicComponent, renderList, withDirectives, createSlots, normalizeClass, createCommentVNode, Transition } from 'vue';
...
var script = {
  ...
  methods: {
    ...
    onItemClick: function onItemClick(e, item2) {
    ...
    changeFocusedOptionIndex: function changeFocusedOptionIndex(index) {
      ...
      var filteredItems = _toConsumableArray(items).filter(function(item2) {
        return item2.getAttribute("data-p-disabled") !== "true";
      });
    ...
    isItemDisabled: function isItemDisabled(item2) {
...
var _hoisted_1 = ["id"];
var _hoisted_2 = ["id", "aria-disabled", "data-p-active", "data-p-disabled"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [createElementVNode("div", mergeProps({
    ...
    return openBlock(), createElementBlock(Fragment, {
      ...
      "data-p-disabled": $options.isItemDisabled(item2) || false
    }, {
      ref_for: true
      ...
      disabled: _ctx.disabled || $options.isItemDisabled(item2),
      unstyled: _ctx.unstyled,
...
export { script as default };;globalThis.__timing__.logEnd('Load chunks/build/index-DwvJJeMK');
//# sourceMappingURL=index-DwvJJeMK.mjs.map
